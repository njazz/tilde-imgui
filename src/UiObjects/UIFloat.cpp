...
void UIFloat::_drawBackground()
{
    ...
    poly[1] = ImVec2(getX() + width-5, getY());
    poly[2] = ImVec2(getX() + width, getY() + 5);
    poly[3] = ImVec2(getX() + width, getY() + height);
    poly[4] = ImVec2(getX(), getY() + height);
    poly[5] = ImVec2(getX(), getY());
